...
public class Exercise002Test {
    ...
    public void checkCanWatchFilm() {
        ...
        assertEquals(false, ex002.canWatchFilm(p1.getAge()));
        assertEquals(true, ex002.canWatchFilm(p2.getAge()));
    }

    @Test
    public void checkIsFromLeeds() {
        Exercise002 ex002 = new Exercise002();

        Person p1 = new Person("Peter", "Smith", "Manchester", 17);
        Person p2 = new Person("Francis", "Farmer", "Leeds", 18);

        assertEquals(false, ex002.isFromLeeds(p1));
        assertEquals(true, ex002.isFromLeeds(p2));
    }
}
